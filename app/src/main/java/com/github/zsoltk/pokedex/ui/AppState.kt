...
import com.github.zsoltk.pokedex.ui.components.bottombar.BottomBarItem
import com.github.zsoltk.pokedex.ui.components.bottombar.TopBottomBarDestinations
...
class AppState(
    ...
    fun navigateToTopLevelDestination(destId: String) {
        ...
        when (dest.qualifiedName) {
            ...
            FavoriteRoute::class.qualifiedName -> {
