...
val TopBottomBarDestinations = listOf(
    BottomBarItem(
        ...
        qualifiedName = HomeScreenRoute::class.qualifiedName!!,
    ),
    BottomBarItem(
        id = "search",
        ...
        qualifiedName = SearchListScreenRoute::class.qualifiedName!!,
    ),
    BottomBarItem(
        id = "favorite",
        ...
        qualifiedName = FavoriteScreenRoute::class.qualifiedName!!,
    ),
)
